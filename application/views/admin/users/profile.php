...
<div id="article">
    ...
    <div class="inner_1"><div class="inner_2"><div class="inner_3"><div class="inner_4 clearfix">
                    ...
                    <div class="row addedit_content">
                        <?php echo form_open_multipart('admin/users/profile'); ?>     
                        ...
                        <fieldset>
                            ...
                            <div class="row form clearfix">
                                <div class="label"><span class="required_mark">*</span><label for="post_ttl">Phone</label></div>
                                <div class="input full">
                                    <div class="input text required">
                            ...
                            <div class="row form clearfix">
                                <div class="label"><span class="required_mark">*</span><label for="post_ttl">Address</label></div>
                                <div class="input full">
