                    ...
                    <div class="row addedit_content">
                        ...
                        <fieldset>
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_input(array('name' => 'key', 'value' => set_value('key'), 'class' => 'field size1')); ?>
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_input(array('name' => 'value', 'value' => set_value('value'), 'class' => 'field size1')); ?>
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_textarea(array('name' => 'description', 'class' => 'field size1', 'value' => set_value('description'))); ?>
