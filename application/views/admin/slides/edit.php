...
<div id="article">
    <h2 class="page_title">Update Slide</h2>
    ...
    <div class="inner_1"><div class="inner_2"><div class="inner_3"><div class="inner_4 clearfix">
                    ...
                    <div class="row addedit_content">
                        <?php echo form_open_multipart('admin/slides/edit'); ?>     
                        ...
                        <fieldset>
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_input(array('name' => 'title', 'value' => set_value('title', isset($slide['title']) ? $slide['title'] : ''))); ?>
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_textarea(array('name' => 'description', 'value' => set_value('description', isset($slide['description']) ? $slide['description'] : ''))); ?>
                            ...
                            <div class="row form clearfix">
                                <div class="label"><label for="post_ttl">Current Image</label></div>
                                <div class="input full"><img src="<?php echo base_url(); ?>timthumb.php?src=<?php echo base_url(); ?><?php echo $image['path'] ?>&h=150&w=150&zc=1" alt=""></div>
                            </div>
                            <div class="row form clearfix">
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input select">
                                        <?php echo form_dropdown('status', $status, $slide['status']); ?>
