...
<div id="article">
    ...
    <div class="inner_1"><div class="inner_2"><div class="inner_3"><div class="inner_4 clearfix">
					...
					<h4 class="page_title" align="right"><u> <a href=" <?php echo base_url();?>index.php/player/orders/addon/<?php echo $order['id']; ?>" >Input Tambahan </u></a></h4>
                    <?php endif ?>
					<br/>
                    ...
                    <h2 class="page_title"><u>Confirmation Data</u></h2>
                        ...
                        <?php echo form_close(); ?>
                    <?php elseif($order['status'] == 3 || $order['status'] == 3): ?>
                          <div class="row addedit_content">
